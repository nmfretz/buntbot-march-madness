...
async function getBracketStandings(url) {
  try {
    ...
    await page.type("#identifierId", process.env.GOOGLE_EMAIL, { delay: 100 }); // delay used for debugging
    await page.keyboard.press("Enter");

    // enter password
    await page.waitForSelector('input[name="password"]');
    await page.waitFor(1000);
    await page.type("#identifierId", process.env.GOOGLE_PASSWORD, { delay: 100 }); // delay used for debugging
    await page.keyboard.press("Enter");
